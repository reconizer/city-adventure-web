    ...
    .row
      ...
      .col-1-2
        .form-control
          ...
          .form-control
            FileUpload(@filesAdded="onCoverAdded" :title="$t('adventure.add_cover_image')")

        .form-control
          label.form-label {{ $t("adventure.promo_images") }}

          FileUpload(@filesAdded="onPromoImagesAdded" :multiple="true" :title="$t('adventure.add_promo_images')")
